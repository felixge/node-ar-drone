...
exports.OPTION_PARSERS = {
  ...
  'phyMeasures': function(reader) {
    return {
      temperature: {
        accelerometer: reader.float32(),
        gyrometer: reader.uint16()
      },
      accelerometers : reader.vector31(),
      gyrometers     : reader.vector31(),
      alim3V3        : reader.uint32(),
      vrefEpson      : reader.uint32(),
      vrefIDG        : reader.uint32()
    };
  },

  'gyrosOffsets': function(reader) {
    return reader.vector31();
  },
  ...
  'vision': function(reader) {
    return {
      ...
      capture       : {
        ...
        // TSECDEC     21 /* Defines used to format time ( seconds << 21 + useconds ) */
        time     : reader.uint32() // TODO: convert from TSECDEC ^
      },
      bodyV         : reader.vector31(),
      delta         : {
        phi   : reader.float32(),
        theta : reader.float32(),
        psi   : reader.float32()
