...
exports.OPTION_PARSERS = {
  ...
  'pwm': function(reader) {
    return {
      motors           : timesMap(4, reader.uint8),
      satMotors        : timesMap(4, reader.uint8),
      ...
      motorCurrents    : timesMap(4, reader.uint16),
  ...
  'adcDataFrame': function(reader) {
    return {
      ...
      dataFrame : timesMap(32, reader.uint8)
    };
  },
  ...
  'windSpeed': function(reader) {
    return {
      ...
      stateX: timesMap(6, reader.float32),
      debug: timesMap(3, reader.float32)
    };
  },
