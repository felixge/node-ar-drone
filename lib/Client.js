...
Client.prototype.config = function(key, value, options) {
  this._udpControl.config(key, value, options);
};

Client.prototype.ctrl = function(controlMode) {
    this._udpControl.ctrl(controlMode);
};
