...
Client.prototype._handleNavdata = function(navdata) {
  ...
  //emit for emergency landing
  if (navdata.droneState && navdata.droneState.emergencyLanding == 1 && this._emergencyLanding == false) {
    this.emergencyLanding = true; //only emit once for emergency landing
    this.emit('emergencyLanding', navdata);
  }

  //callbacks for landing and takeoff
